...
void adventurerCard(int cardDrawn, int currentPlayer, int handPos, struct gameState *state, int drawntreasure, int *temphand)
{
	int z=0; 
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
     	adventurerCard(cardDrawn, currentPlayer, handPos, state, drawntreasure, &temphand);
      return 0;
    ...
    case steward:
	stewardCard(choice1, choice2, choice3, currentPlayer, handPos, state);
      return 0;
